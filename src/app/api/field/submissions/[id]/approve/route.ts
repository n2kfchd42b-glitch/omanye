// PATCH /api/field/submissions/:id/approve
// Approves a flagged submission from the moderation queue.
// Clears flagged_for_review and marks the submission as REVIEWED.
...
export async function PATCH(_req: NextRequest, { params }: RouteParams) {
  ...
  void logActionForUser(user.id, {
    ...
    metadata:   { program_id: d.program_id as string, via: 'moderation_queue' },
  })
